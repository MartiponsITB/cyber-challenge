  ...
  return <div className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {challengeData.map(challenge => <div key={challenge.id} className="relative">
              {getCompletionStatus(challenge.id) && <div className="absolute -top-3 -right-3 z-10 bg-green-500 text-black rounded-full p-1">
        ...
        <div className="mt-16 text-center">
          <h2 className="text-3xl font-mono font-bold cyber-text mb-8">Hackathon</h2>
          ...
          <div className="cyber-card max-w-2xl mx-auto">
            <div className="flex justify-center mb-6">
              <div className="w-24 h-24 bg-black cyber-border rounded-md flex items-center justify-center">
                {isHackathonUnlocked ? <svg className="w-12 h-12 text-cyber" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg> : <Lock className="w-12 h-12 text-cyber" />}
              </div>
            </div>
